...
<div style="padding-left: 6%; padding-right: 6%; padding-bottom: 2.5%; padding-top: 2.5%; ">
                 <?php
                    ...
                    $sql = "SELECT Emri, Mbiemri, Nr_ID, Statusi FROM perdouesit where Statusi='Drejtor'";
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = $result->fetch_array()){
                                    echo "<tr>";
                                        ...
                                        echo "<a href='fshirja-drejtorit.php?Nr_ID=". $row['Nr_ID'] ."' title='Fshij' data-toggle='tooltip'><i class='fas fa-trash-alt'></i> </a>";
                                        echo "<a href='shiko-te-dhenat-drejtorit.php?Nr_ID=". $row['Nr_ID'] ."' title='Shiko të dhënat' data-toggle='tooltip'><i class='fas fa-eye'></i> </a>";
                                        echo "<a href='logjika-ndryshimi-drejtorit.php?Nr_ID=". $row['Nr_ID'] ."' title='Ndrysho të dhënat' data-toggle='tooltip'><i class='fas fa-user-edit'></i> </a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
                            echo "</table>";
                            // Vendosni rezultat falas
                            $result->free();
                        } else{

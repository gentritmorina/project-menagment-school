...
<head>
  <!--Titulli faqes-->
  <title>Regjistrimi i Kujdestarit - ditariElektronik</title>
...
<div style="padding: 4%;">
 <div class="card">
  <h6 class="card-header"><b>Regjistrimi i Kujdestarit</b></h6>
  <div class="card-body">
   <form action="regjistrimi_kujdestarit.php" method="post">
    <table>
    <tr>
    ...
    <tr>
      <td>Statusi<input type="text" value="Kujdestar" class="form-control" name="Statusi"  readonly></td>

...
<button type="button"  style="margin-top: 1%; margin-bottom: 1%;" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
  <i class="fas fa-chalkboard-teacher"></i> Evidenca
</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"> <i class="fas fa-chalkboard-teacher"></i> Evidenca</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
         <font><b>Nxënësi</b></font><input type="text" name="nxenesi" class="form-control">
         <font><b>Mungesat me arsye</b></font><input type="text" name="m" class="form-control">
         <font><b>Mungesat pa arsye</b></font><input type="text" name="p" class="form-control">
         <font><b>Muaji</b></font>
         <select class="custom-select" id="inputGroupSelect01" name="muaji">
            <option selected>Zgjedh muajin...</option>
            ...
            <option value="Qeshor">Qeshor</option>
        </select>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Mbyll</button>
        <input type="submit" name="ruaj" value="Ruaj" class="btn btn-primary">
      </div>
    </div>
  </div>
</div>
